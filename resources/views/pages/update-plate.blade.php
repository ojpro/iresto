        ...
        <form action="{{ route('plates.update',$plate->id) }}" method="post">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="name"
                       ...
                       placeholder="PLate Name" name="name" required value="{{ $plate->name }}" />
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" id="price"
                       class="block w-full rounded-md border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                       placeholder="PLate Price" name="price" required value="{{ $plate->price }}" />
            </div>
            ...
            <div class="mb-6">
                ...
                <select id="countries" name="category_id"
                    ...
                    @foreach($categories as $category)
                        <option value="{{$category->id}}" @if($category->id == $plate->category_id) selected @endif>{{$category->label}}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea id="message" rows="4"
                          ...
                          placeholder="Plate Description..." name="description">{{ $plate->description }}
                </textarea>
            </div>
