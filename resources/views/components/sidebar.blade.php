    ...
    <div class="flex bg-red-400">
        ...
        >
            ...
            <nav class="mt-10">
                ...
                <a  class="flex items-center px-6 py-2 mt-4 duration-200 text-gray-500 hover:bg-gray-600 hover:bg-opacity-25 hover:text-gray-100 border-l-4 hover:border-gray-300 bg-opacity-25 {{ Request::routeIs('orders.*') ? 'border-gray-500 bg-gray-700' : 'border-gray-900' }}"
                    href="{{ route('orders.index') }}"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ionicon" viewBox="0 0 512 512"><title>Cart</title><circle cx="176" cy="416" r="16" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/><circle cx="400" cy="416" r="16" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M48 80h64l48 272h256"/><path d="M160 288h249.44a8 8 0 007.85-6.43l28.8-144a8 8 0 00-7.85-9.57H128" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/></svg>
